...
def seed_expense_details():
    ...
    det10=ExpenseDetail(expense_id= 10, contributer_id= 1, amount= 60, settled = False)
    det11=ExpenseDetail(expense_id= 10, contributer_id= 2, amount= 60, settled = False)
    det111=ExpenseDetail(expense_id= 10, contributer_id= 3, amount= 60, settled = False)
    det20=ExpenseDetail(expense_id= 11, contributer_id= 1, amount= 15, settled = False)
    det23=ExpenseDetail(expense_id= 11, contributer_id= 2, amount= 15, settled = False)
    det24=ExpenseDetail(expense_id= 11, contributer_id= 3, amount= 15, settled = False)
    ...
    db.session.add(det10)
    db.session.add(det111)
    db.session.add(det11)
    db.session.add(det20)
    db.session.add(det23)
    db.session.add(det24)
    db.session.commit()
